...
private:
  ...
  std::deque<std::pair<InternetDatagram, uint32_t>> datagrams_queue {};
  std::map<uint32_t, std::pair<EthernetAddress, uint32_t>> arp_map_ {};
  std::map<uint32_t, uint32_t> arp_requery_map_ {};
};
